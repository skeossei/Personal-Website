      ...
      <div>
        ...
        <div className="high-school-body">
          ...
          <p>
            ...
            school gets an aggregated csv file at the end of each month for every student that made
            a payment through MachForm. They also get a csv file from PayPal that states whether or
            not a payment was processed properly.
          </p>
          <p>
            So, I created a python script that reads both of these files, checks to see if the
